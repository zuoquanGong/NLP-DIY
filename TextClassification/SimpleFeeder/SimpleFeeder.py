...
class InstanceList(List):
    ...
    def read(self,
        ...
        self.clear()
        if no_fix:
            self.extend(reader(path, read_model, char_filter=char_filter, line_filter_mark=line_filter_mark,
                               txt_filter=txt_filter,has_head=has_head))
        else:
            self.extend(reader(path, read_model,
                               separator=separator, minicut=minicut,
                               char_filter=char_filter, line_filter_mark=line_filter_mark,
                               txt_filter=txt_filter,has_head=has_head))
